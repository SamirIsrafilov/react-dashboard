...
import UsersImg from '../img/user.svg'
      ...
      <div className='catalog_header'>
        <nav className="navbar">
          <div className="container-fluid">
            <h2 className="navbar-brand text-white">Users <span>3,702 Total</span> </h2>
            <div className='d-flex flex-column flex-md-row catalog_form'>
              ...
              <form className="d-flex catalog_search" role="search">
                <input className="form-control" type="search" placeholder="Find users.." aria-label="Search" />
              ...
              catalogdata.map((fd, i) => {
                return (
                  <tr key={i}>
                    ...
                    <td className='align-middle text-nowrap '><img className='rounded-circle me-2 float-start' src={UsersImg} />
                      <div className='float-start '>
                        <h6 className='m-0 '>John Doe</h6>
                        <p className='text-normal text-muted m-0'>email@email.com</p>
                      </div>
                    </td>
                    <td className='align-middle my-auto'>Username</td>
                    <td className='align-middle'>{fd.pricing}</td>
                    <td className='align-middle'>{fd.comment}</td>
                    <td className='align-middle'>{fd.reviews}</td>
